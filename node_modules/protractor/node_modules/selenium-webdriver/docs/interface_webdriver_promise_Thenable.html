...
</dl></div></div></div></div><hr class="fn-sep"><div id="isPending" class="function"><div><h3>isPending()<span class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l894">code »</a></span></h3><div><div class="fn-details"><div><b>Returns</b></div><dl><dt><code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean">boolean</a></code><dd><p>Whether this promise&#39;s value is still being computed.</p>
</dl></div></div></div></div><hr class="fn-sep"><div id="then" class="function"><div><h3><code>&lt;R&gt;</code> then(<wbr>opt_callback, opt_errback)<span class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l909">code »</a></span></h3><p>Registers listeners for when this instance is resolved.</p>
...
</dl></div></div></div></div><hr class="fn-sep"><div id="thenCatch" class="function"><div><h3><code>&lt;R&gt;</code> thenCatch(<wbr>errback)<span class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l934">code »</a></span></h3><p>Registers a listener for when this promise is rejected. This is synonymous
...
resolved with the result of the invoked callback.</p>
</dl></div></div></div></div><hr class="fn-sep"><div id="thenFinally" class="function"><div><h3><code>&lt;R&gt;</code> thenFinally(<wbr>callback)<span class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l972">code »</a></span></h3><p>Registers a listener to invoke when this promise is resolved, regardless
...
</dl></div></div></div></div><h2>Functions</h2><div id="Thenable.addImplementation" class="function"><div><h3>Thenable.addImplementation(<wbr>ctor)<span class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l847">code »</a></span></h3><p>Adds a property to a class prototype to allow runtime checks of whether
instances of that class implement the Thenable interface. This function
will also ensure the prototype&#39;s <code>then</code> function is exported from
compiled code.</p>
...
</dl></div></div></div></div><hr class="fn-sep"><div id="Thenable.isImplementation" class="function"><div><h3>Thenable.isImplementation(<wbr>object)<span class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l870">code »</a></span></h3><p>Checks if an object has been tagged for implementing the Thenable
interface as defined by
<a href="interface_webdriver_promise_Thenable.html#Thenable.addImplementation"><code>webdriver.promise.Thenable.addImplementation</code></a>.</p>
