...
functions, one for fulfilling the promise and another for rejecting it.</p>
...
</dl></div></div><h2>Instance Methods</h2><div id="cancel" class="function"><div><h3>cancel(<wbr>opt_reason)<span class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l1211">code »</a></span></h3><p>Cancels the computation of this promise&#39;s value, rejecting the promise in
...
</dl></div></div></div></div><hr class="fn-sep"><div id="thenCatch" class="function"><div><h3>thenCatch(<wbr>errback)<span class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l1250">code »</a></span></h3><p>Registers a listener for when this promise is rejected. This is synonymous
...
resolved with the result of the invoked callback.</p>
</dl></div></div></div></div><hr class="fn-sep"><div id="thenFinally" class="function"><div><h3>thenFinally(<wbr>callback)<span class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l1256">code »</a></span></h3><p>Registers a listener to invoke when this promise is resolved, regardless
