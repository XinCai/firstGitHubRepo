<!DOCTYPE html><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, user-scalable=no"><meta http-equiv="Content-Language" content="en"><meta http-equiv="X-UA-Compatible" content="IE=edge"><title>CancellationError</title><link href="dossier.css" rel="stylesheet" type="text/css"><header><div><form><div><input type="search" placeholder="Search" tabindex="1"></div></form></div></header><main><article><div class="parentlink"><b>Namespace:</b> <a href="namespace_webdriver_promise.html">webdriver.promise</a></div><div class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l708">View Source</a></div><h1>class CancellationError</h1><pre class="inheritance"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error">Error</a>
  &#x2514; goog.debug.Error
      &#x2514; webdriver.promise.CancellationError</pre><p>Error used when the computation of a promise is cancelled.</p>
<h3>new CancellationError(<wbr>opt_msg)</h3><div><div class="fn-details"><div><b>Parameters</b></div><dl><dt>opt_msg<code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a>=</code><dd><p>The cancellation message.</p>
...
</dl></div><div id="stack" class="property"><dl><dt><a href="source/lib/goog/debug/error.js.src.html#l42">stack</a><code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a></code><dd>No description.</dl></div><h2>Static Functions</h2><div id="CancellationError.wrap" class="function"><div><h3>CancellationError.wrap(<wbr>error, opt_msg)<span class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l730">code »</a></span></h3><p>Wraps the given error in a CancellationError.</p>
<div><div class="fn-details"><div><b>Parameters</b></div><dl><dt>error<code>*</code><dd><p>The error to wrap.</p>
<dt>opt_msg<code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a>=</code><dd><p>The prefix message to use.</p>
</dl></div><div class="fn-details"><div><b>Returns</b></div><dl><dt><code><a href="class_webdriver_promise_CancellationError.html">webdriver.promise.CancellationError</a></code><dd><p>A cancellation error.</p>
