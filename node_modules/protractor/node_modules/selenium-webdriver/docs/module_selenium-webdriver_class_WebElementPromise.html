<!DOCTYPE html><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, user-scalable=no"><meta http-equiv="Content-Language" content="en"><meta http-equiv="X-UA-Compatible" content="IE=edge"><title>WebElementPromise</title><link href="dossier.css" rel="stylesheet" type="text/css"><header><div><form><div><input type="search" placeholder="Search" tabindex="1"></div></form></div></header><main><article><div class="parentlink"><b>Module:</b> <a href="module_selenium-webdriver.html">selenium-webdriver</a></div><div class="codelink"><a href="source/index.js.src.html#l78">View Source</a></div><h1>class WebElementPromise</h1><pre class="inheritance"><a href="class_webdriver_Serializable.html">webdriver.Serializable</a>&lt;{ELEMENT: <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a>}&gt;
  &#x2514; <a href="class_webdriver_WebElement.html">webdriver.WebElement</a>
      &#x2514; WebElementPromise</pre><dl><dt>Alias for <code><a href="class_webdriver_WebElementPromise.html">webdriver.WebElementPromise</a></code><dt>All implemented interfaces<dd><code>IThenable&lt;T&gt;</code><dd><code><a href="interface_webdriver_promise_Thenable.html">webdriver.promise.Thenable</a>&lt;<a href="class_webdriver_WebElement.html">webdriver.WebElement</a>&gt;</code></dl><p>WebElementPromise is a promise that will be fulfilled with a WebElement.
...
<h3>new WebElementPromise(<wbr>driver, el)</h3><div><div class="fn-details"><div><b>Parameters</b></div><dl><dt>driver<code><a href="class_webdriver_WebDriver.html">webdriver.WebDriver</a></code><dd><p>The parent WebDriver instance for this
element.</p>
<dt>el<code><a href="class_webdriver_promise_Promise.html">webdriver.promise.Promise</a>&lt;<a href="class_webdriver_WebElement.html">webdriver.WebElement</a>&gt;</code><dd><p>A promise
that will resolve to the promised element.</p>
</dl></div></div><h2>Instance Methods</h2><div id="cancel" class="function"><div><h3>cancel(<wbr>opt_reason)<span class="codelink"><a href="source/lib/webdriver/webdriver.js.src.html#l2264">code »</a></span></h3><p>Cancels the computation of this promise&#39;s value, rejecting the promise in
...
</dl></div></div></div></div><hr class="fn-sep"><div id="clear" class="function"><div><h3>clear()<span class="codelink"><a href="source/lib/webdriver/webdriver.js.src.html#l2171">code »</a></span></h3><p>Schedules a command to clear the <code>value</code> of this element. This command
...
element is present on the page, use <a href="module_selenium-webdriver_class_WebElementPromise.html#isElementPresent"><code>#isElementPresent</code></a> instead.</p>
...
<p><b>Defined by: </b><a href="class_webdriver_WebElement.html#getAttribute">webdriver.WebElement</a></p><div><div class="fn-details"><div><b>Parameters</b></div><dl><dt>attributeName<code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a></code><dd><p>The name of the attribute to query.</p>
...
<p><b>Defined by: </b><a href="class_webdriver_WebElement.html#getCssValue">webdriver.WebElement</a></p><div><div class="fn-details"><div><b>Parameters</b></div><dl><dt>cssStyleProperty<code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a></code><dd><p>The name of the CSS style property to look
up.</p>
</dl></div><div class="fn-details"><div><b>Returns</b></div><dl><dt><code><a href="class_webdriver_promise_Promise.html">webdriver.promise.Promise</a>&lt;<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a>&gt;</code><dd><p>A promise that will be
...
</dl></div></div></div></div><hr class="fn-sep"><div id="getId" class="function"><div><h3>getId()<span class="codelink"><a href="source/lib/webdriver/webdriver.js.src.html#l2283">code »</a></span></h3><p>Defers returning the element ID until the wrapped WebElement has been
resolved.</p>
<p><b>Overrides: </b><a href="class_webdriver_WebElement.html#getId">webdriver.WebElement</a></p><div><div class="fn-details"><div><b>Returns</b></div><dl><dt><code><a href="class_webdriver_promise_Promise.html">webdriver.promise.Promise</a>&lt;{ELEMENT: <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a>}&gt;</code><dd><p>A promise
that resolves to this element&#39;s JSON representation as defined by the
WebDriver wire protocol.</p>
</dl></div></div></div></div><hr class="fn-sep"><div id="getInnerHtml" class="function"><div><h3>getInnerHtml()<span class="codelink"><a href="source/lib/webdriver/webdriver.js.src.html#l2233">code »</a></span></h3><p>Schedules a command to retrieve the inner HTML of this element.</p>
...
</dl></div></div></div></div><hr class="fn-sep"><div id="getOuterHtml" class="function"><div><h3>getOuterHtml()<span class="codelink"><a href="source/lib/webdriver/webdriver.js.src.html#l2214">code »</a></span></h3><p>Schedules a command to retrieve the outer HTML of this element.</p>
...
<p><b>Defined by: </b><a href="class_webdriver_WebElement.html#getRawId">webdriver.WebElement</a></p><div><div class="fn-details"><div><b>Returns</b></div><dl><dt><code><a href="class_webdriver_promise_Promise.html">webdriver.promise.Promise</a>&lt;<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a>&gt;</code><dd><p>A promise that resolves to this
...
<p><b>Defined by: </b><a href="class_webdriver_WebElement.html#isDisplayed">webdriver.WebElement</a></p><div><div class="fn-details"><div><b>Returns</b></div><dl><dt><code><a href="class_webdriver_promise_Promise.html">webdriver.promise.Promise</a>&lt;<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean">boolean</a>&gt;</code><dd><p>A promise that will be
...
</dl></div></div></div></div><hr class="fn-sep"><div id="takeScreenshot" class="function"><div><h3>takeScreenshot(<wbr>opt_scroll)<span class="codelink"><a href="source/lib/webdriver/webdriver.js.src.html#l2200">code »</a></span></h3><p>Take a screenshot of the visible region encompassed by this element&#39;s
bounding rectangle.</p>
<p><b>Defined by: </b><a href="class_webdriver_WebElement.html#takeScreenshot">webdriver.WebElement</a></p><div><div class="fn-details"><div><b>Parameters</b></div><dl><dt>opt_scroll<code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean">boolean</a>=</code><dd><p>Optional argument that indicates whether the
...
</dl></div></div></div></div><hr class="fn-sep"><div id="then" class="function"><div><h3>then(<wbr>opt_callback, opt_errback)<span class="codelink"><a href="source/lib/webdriver/webdriver.js.src.html#l2270">code »</a></span></h3><p>Registers listeners for when this instance is resolved.</p>
...
</dl></div></div></div></div><hr class="fn-sep"><div id="thenCatch" class="function"><div><h3>thenCatch(<wbr>errback)<span class="codelink"><a href="source/lib/webdriver/webdriver.js.src.html#l2273">code »</a></span></h3><p>Registers a listener for when this promise is rejected. This is synonymous
...
resolved with the result of the invoked callback.</p>
</dl></div></div></div></div><hr class="fn-sep"><div id="thenFinally" class="function"><div><h3>thenFinally(<wbr>callback)<span class="codelink"><a href="source/lib/webdriver/webdriver.js.src.html#l2276">code »</a></span></h3><p>Registers a listener to invoke when this promise is resolved, regardless
