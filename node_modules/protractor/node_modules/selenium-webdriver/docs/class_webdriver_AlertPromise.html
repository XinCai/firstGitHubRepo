...
<h3>new AlertPromise(<wbr>driver, alert)</h3><div><div class="fn-details"><div><b>Parameters</b></div><dl><dt>driver<code><a href="class_webdriver_WebDriver.html">webdriver.WebDriver</a></code><dd><p>The driver controlling the browser this
alert is attached to.</p>
<dt>alert<code><a href="interface_webdriver_promise_Thenable.html">webdriver.promise.Thenable</a>&lt;<a href="class_webdriver_Alert.html">webdriver.Alert</a>&gt;</code><dd><p>A thenable
that will be fulfilled with the promised alert.</p>
</dl></div></div><h2>Instance Methods</h2><div id="accept" class="function"><div><h3>accept()<span class="codelink"><a href="source/lib/webdriver/webdriver.js.src.html#l2415">code »</a></span></h3><p>Defers action until the alert has been located.</p>
<p><b>Overrides: </b><a href="class_webdriver_Alert.html#accept">webdriver.Alert</a></p><div><div class="fn-details"><div><b>Returns</b></div><dl><dt><code><a href="class_webdriver_promise_Promise.html">webdriver.promise.Promise</a>&lt;<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Undefined">undefined</a>&gt;</code><dd><p>A promise that will be resolved
when this command has completed.</p>
</dl></div></div></div></div><hr class="fn-sep"><div id="cancel" class="function"><div><h3>cancel(<wbr>opt_reason)<span class="codelink"><a href="source/lib/webdriver/webdriver.js.src.html#l2387">code »</a></span></h3><p>Cancels the computation of this promise&#39;s value, rejecting the promise in
...
</dl></div></div></div></div><hr class="fn-sep"><div id="dismiss" class="function"><div><h3>dismiss()<span class="codelink"><a href="source/lib/webdriver/webdriver.js.src.html#l2425">code »</a></span></h3><p>Defers action until the alert has been located.</p>
<p><b>Overrides: </b><a href="class_webdriver_Alert.html#dismiss">webdriver.Alert</a></p><div><div class="fn-details"><div><b>Returns</b></div><dl><dt><code><a href="class_webdriver_promise_Promise.html">webdriver.promise.Promise</a>&lt;<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Undefined">undefined</a>&gt;</code><dd><p>A promise that will be resolved
when this command has completed.</p>
</dl></div></div></div></div><hr class="fn-sep"><div id="getText" class="function"><div><h3>getText()<span class="codelink"><a href="source/lib/webdriver/webdriver.js.src.html#l2405">code »</a></span></h3><p>Defer returning text until the promised alert has been resolved.</p>
<p><b>Overrides: </b><a href="class_webdriver_Alert.html#getText">webdriver.Alert</a></p><div><div class="fn-details"><div><b>Returns</b></div><dl><dt><code><a href="class_webdriver_promise_Promise.html">webdriver.promise.Promise</a>&lt;<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a>&gt;</code><dd><p>A promise that will be
resolved to the text displayed with this alert.</p>
</dl></div></div></div></div><hr class="fn-sep"><div id="isPending" class="function"><div><h3>isPending()<span class="codelink"><a href="source/lib/webdriver/webdriver.js.src.html#l2390">code »</a></span></h3><p><b>Specified by: </b><a href="interface_webdriver_promise_Thenable.html#isPending">webdriver.promise.Thenable</a></p><div><div class="fn-details"><div><b>Returns</b></div><dl><dt><code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean">boolean</a></code><dd><p>Whether this promise&#39;s value is still being computed.</p>
</dl></div></div></div></div><hr class="fn-sep"><div id="sendKeys" class="function"><div><h3>sendKeys(<wbr>text)<span class="codelink"><a href="source/lib/webdriver/webdriver.js.src.html#l2435">code »</a></span></h3><p>Defers action until the alert has been located.</p>
<p><b>Overrides: </b><a href="class_webdriver_Alert.html#sendKeys">webdriver.Alert</a></p><div><div class="fn-details"><div><b>Parameters</b></div><dl><dt>text<code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a></code><dd><p>The text to set.</p>
...
when this command has completed.</p>
</dl></div></div></div></div><hr class="fn-sep"><div id="then" class="function"><div><h3>then(<wbr>opt_callback, opt_errback)<span class="codelink"><a href="source/lib/webdriver/webdriver.js.src.html#l2393">code »</a></span></h3><p>Registers listeners for when this instance is resolved.</p>
...
</dl></div></div></div></div><hr class="fn-sep"><div id="thenCatch" class="function"><div><h3>thenCatch(<wbr>errback)<span class="codelink"><a href="source/lib/webdriver/webdriver.js.src.html#l2396">code »</a></span></h3><p>Registers a listener for when this promise is rejected. This is synonymous
...
resolved with the result of the invoked callback.</p>
</dl></div></div></div></div><hr class="fn-sep"><div id="thenFinally" class="function"><div><h3>thenFinally(<wbr>callback)<span class="codelink"><a href="source/lib/webdriver/webdriver.js.src.html#l2399">code »</a></span></h3><p>Registers a listener to invoke when this promise is resolved, regardless
