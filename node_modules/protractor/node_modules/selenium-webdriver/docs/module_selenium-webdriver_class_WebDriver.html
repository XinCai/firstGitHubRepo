...
<h3>new WebDriver(<wbr>session, executor, opt_flow)</h3><div><div class="fn-details"><div><b>Parameters</b></div><dl><dt>session<code>(<a href="class_webdriver_Session.html">webdriver.Session</a>|<a href="class_webdriver_promise_Promise.html">webdriver.promise.Promise</a>)</code><dd><p>Either a
known session or a promise that will be resolved to a session.</p>
<dt>executor<code><a href="interface_webdriver_CommandExecutor.html">webdriver.CommandExecutor</a></code><dd><p>The executor to use when
...
<div><div class="fn-details"><div><b>Returns</b></div><dl><dt><code><a href="class_webdriver_ActionSequence.html">webdriver.ActionSequence</a></code><dd><p>A new action sequence for this instance.</p>
...
<p>Unlike executing synchronous JavaScript with <a href="module_selenium-webdriver_class_WebDriver.html#executeScript"><code>#executeScript</code></a>,
...
present on the page, use <a href="module_selenium-webdriver_class_WebDriver.html#isElementPresent"><code>#isElementPresent</code></a> instead.</p>
...
driver will attempt to retrieve it through <a href="module_selenium-webdriver_class_WebDriver.html#executeScript"><code>#executeScript</code></a>. If the
...
<div><div class="fn-details"><div><b>Parameters</b></div><dl><dt>url<code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a></code><dd><p>The fully qualified URL to open.</p>
...
<div><div class="fn-details"><div><b>Parameters</b></div><dl><dt>command<code><a href="class_webdriver_Command.html">webdriver.Command</a></code><dd><p>The command to schedule.</p>
...
</dl></div></div></div></div><hr class="fn-sep"><div id="setFileDetector" class="function"><div><h3>setFileDetector(<wbr>detector)<span class="codelink"><a href="source/lib/webdriver/webdriver.js.src.html#l407">code »</a></span></h3><p>Sets the <a href="class_webdriver_FileDetector.html">file detector</a> that should be
used with this instance.</p>
<div><div class="fn-details"><div><b>Parameters</b></div><dl><dt>detector<code><a href="class_webdriver_FileDetector.html">webdriver.FileDetector</a></code><dd><p>The detector to use or <code>null</code>.</p>
...
<div><div class="fn-details"><div><b>Returns</b></div><dl><dt><code><a href="class_webdriver_TouchSequence.html">webdriver.TouchSequence</a></code><dd><p>A new touch sequence for this instance.</p>
...
</dl></div></div></div></div><h2>Static Functions</h2><div id="WebDriver.attachToSession" class="function"><div><h3>WebDriver.attachToSession(<wbr>executor, sessionId, opt_flow)<span class="codelink"><a href="source/lib/webdriver/webdriver.js.src.html#l108">code »</a></span></h3><p>Creates a new WebDriver client for an existing session.</p>
<div><div class="fn-details"><div><b>Parameters</b></div><dl><dt>executor<code><a href="interface_webdriver_CommandExecutor.html">webdriver.CommandExecutor</a></code><dd><p>Command executor to use when
querying for session details.</p>
<dt>sessionId<code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a></code><dd><p>ID of the session to attach to.</p>
<dt>opt_flow<code>?<a href="class_webdriver_promise_ControlFlow.html">webdriver.promise.ControlFlow</a>=</code><dd><p>The control flow all driver
commands should execute under. Defaults to the
<a href="namespace_webdriver_promise.html#controlFlow"><code>currently active</code></a>  control flow.</p>
</dl></div><div class="fn-details"><div><b>Returns</b></div><dl><dt><code><a href="class_webdriver_WebDriver.html">webdriver.WebDriver</a></code><dd><p>A new client for the specified session.</p>
</dl></div></div></div></div><hr class="fn-sep"><div id="WebDriver.createSession" class="function"><div><h3>WebDriver.createSession(<wbr>executor, desiredCapabilities, opt_flow)<span class="codelink"><a href="source/lib/webdriver/webdriver.js.src.html#l129">code »</a></span></h3><p>Creates a new WebDriver session.</p>
<div><div class="fn-details"><div><b>Parameters</b></div><dl><dt>executor<code><a href="interface_webdriver_CommandExecutor.html">webdriver.CommandExecutor</a></code><dd><p>The executor to create the new
session with.</p>
<dt>desiredCapabilities<code><a href="class_webdriver_Capabilities.html">webdriver.Capabilities</a></code><dd><p>The desired
capabilities for the new session.</p>
<dt>opt_flow<code>?<a href="class_webdriver_promise_ControlFlow.html">webdriver.promise.ControlFlow</a>=</code><dd><p>The control flow all driver
commands should execute under, including the initial session creation.
Defaults to the <a href="namespace_webdriver_promise.html#controlFlow"><code>currently active</code></a>
control flow.</p>
</dl></div><div class="fn-details"><div><b>Returns</b></div><dl><dt><code><a href="class_webdriver_WebDriver.html">webdriver.WebDriver</a></code><dd><p>The driver for the newly created session.</p>
</dl></div></div></div></div><h2>Types</h2><dl><dt><a href="class_webdriver_WebDriver_Logs.html">WebDriver.Logs</a><dd><p>Interface for managing WebDriver log records.</p>
<dt><a href="class_webdriver_WebDriver_Navigation.html">WebDriver.Navigation</a><dd><p>Interface for navigating back and forth in the browser history.</p>
<dt><a href="class_webdriver_WebDriver_Options.html">WebDriver.Options</a><dd><p>Provides methods for managing browser and driver state.</p>
<dt><a href="class_webdriver_WebDriver_TargetLocator.html">WebDriver.TargetLocator</a><dd><p>An interface for changing the focus of the driver to another frame or window.</p>
<dt><a href="class_webdriver_WebDriver_Timeouts.html">WebDriver.Timeouts</a><dd><p>An interface for managing timeout behavior for WebDriver instances.</p>
<dt><a href="class_webdriver_WebDriver_Window.html">WebDriver.Window</a><dd><p>An interface for managing the current window.</p>
