...
until <a href="module_selenium-webdriver_class_ActionSequence.html#keyUp"><code>#keyUp</code></a> or <a href="module_selenium-webdriver_class_ActionSequence.html#sendKeys"><code>#sendKeys</code></a> is called. The key press will be
...
<a href="module_selenium-webdriver_class_ActionSequence.html#mouseUp"><code>#mouseUp</code></a> is called, regardless of whether that call is made in this
...
without a previous call to <a href="module_selenium-webdriver_class_ActionSequence.html#mouseDown"><code>#mouseDown</code></a>.</p>
<p>If an element is provided, the mouse will first be moved to the center
of that element. This is equivalent to:</p>
