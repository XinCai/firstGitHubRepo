...
U.prototype.i=function(a,b,c,d){return this.F.remove(String(a),b,c,d)};function ec(a,b,c,d){b=a.F.a[String(b)];if(!b)return!0;b=b.concat();for(var e=!0,f=0;f<b.length;++f){var g=b[f];if(g&&!g.H&&g.M==c){var h=g.listener,k=g.N||g.src;g.L&&bb(a.F,g);e=!1!==h.call(k,d)&&e}}return e&&0!=d.ia};function fc(a,b,c,d,e){if(!(J||L&&N("525")))return!0;if(M&&e)return gc(a);if(e&&!d)return!1;"number"==typeof b&&(b=hc(b));if(!c&&(17==b||18==b||M&&91==b))return!1;if(L&&d&&c)switch(a){case 220:case 219:case 221:case 192:case 186:case 189:case 187:case 188:case 190:case 191:case 192:case 222:return!1}if(J&&d&&b==a)return!1;switch(a){case 13:return!0;case 27:return!L}return gc(a)}
function gc(a){if(48<=a&&57>=a||96<=a&&106>=a||65<=a&&90>=a||L&&0==a)return!0;switch(a){case 32:case 63:case 107:case 109:case 110:case 111:case 186:case 59:case 189:case 187:case 61:case 188:case 190:case 191:case 192:case 222:case 219:case 220:case 221:return!0;default:return!1}}function hc(a){if(K)a=ic(a);else if(M&&L)a:switch(a){case 93:a=91;break a}return a}
function ic(a){switch(a){case 61:return 187;case 59:return 186;case 173:return 189;case 224:return 91;case 0:return 224;default:return a}};function jc(a,b){U.call(this);a&&kc(this,a,b)}v(jc,U);l=jc.prototype;l.I=null;l.O=null;l.V=null;l.P=null;l.s=-1;l.w=-1;l.T=!1;
var lc={3:13,12:144,63232:38,63233:40,63234:37,63235:39,63236:112,63237:113,63238:114,63239:115,63240:116,63241:117,63242:118,63243:119,63244:120,63245:121,63246:122,63247:123,63248:44,63272:46,63273:36,63275:35,63276:33,63277:34,63289:144,63302:45},mc={Up:38,Down:40,Left:37,Right:39,Enter:13,F1:112,F2:113,F3:114,F4:115,F5:116,F6:117,F7:118,F8:119,F9:120,F10:121,F11:122,F12:123,"U+007F":46,Home:36,End:35,PageUp:33,PageDown:34,Insert:45},nc=J||L&&N("525"),oc=M&&K;
jc.prototype.a=function(a){L&&(17==this.s&&!a.ctrlKey||18==this.s&&!a.b||M&&91==this.s&&!a.metaKey)&&(this.w=this.s=-1);-1==this.s&&(a.ctrlKey&&17!=a.keyCode?this.s=17:a.b&&18!=a.keyCode?this.s=18:a.metaKey&&91!=a.keyCode&&(this.s=91));nc&&!fc(a.keyCode,this.s,a.l,a.ctrlKey,a.b)?this.handleEvent(a):(this.w=hc(a.keyCode),oc&&(this.T=a.b))};jc.prototype.b=function(a){this.w=this.s=-1;this.T=a.b};
jc.prototype.handleEvent=function(a){var b=a.c,c,d,e=b.altKey;J&&"keypress"==a.type?(c=this.w,d=13!=c&&27!=c?b.keyCode:0):L&&"keypress"==a.type?(c=this.w,d=0<=b.charCode&&63232>b.charCode&&gc(c)?b.charCode:0):nb?(c=this.w,d=gc(c)?b.keyCode:0):(c=b.keyCode||this.w,d=b.charCode||0,oc&&(e=this.T),M&&63==d&&224==c&&(c=191));var f=c=hc(c),g=b.keyIdentifier;c?63232<=c&&c in lc?f=lc[c]:25==c&&a.l&&(f=9):g&&g in mc&&(f=mc[g]);this.s=f;a=new pc(f,d,0,b);a.b=e;V(this,a)};
function kc(a,b,c){a.P&&qc(a);a.I=b;a.O=S(a.I,"keypress",a,c);a.V=S(a.I,"keydown",a.a,c,a);a.P=S(a.I,"keyup",a.b,c,a)}function qc(a){a.O&&(T(a.O),T(a.V),T(a.P),a.O=null,a.V=null,a.P=null);a.I=null;a.s=-1;a.w=-1}function pc(a,b,c,d){R.call(this,d);this.type="key";this.keyCode=a;this.i=b}v(pc,R);function W(a,b){var c=Q(a);return c.defaultView&&c.defaultView.getComputedStyle&&(c=c.defaultView.getComputedStyle(a,null))?c[b]||c.getPropertyValue(b)||"":""}function X(a,b){return W(a,b)||(a.currentStyle?a.currentStyle[b]:null)||a.style&&a.style[b]}
function rc(a){var b;try{b=a.getBoundingClientRect()}catch(c){return{left:0,top:0,right:0,bottom:0}}J&&a.ownerDocument.body&&(a=a.ownerDocument,b.left-=a.documentElement.clientLeft+a.body.clientLeft,b.top-=a.documentElement.clientTop+a.body.clientTop);return b}
function sc(a){if(J&&!O(8))return a.offsetParent;var b=Q(a),c=X(a,"position"),d="fixed"==c||"absolute"==c;for(a=a.parentNode;a&&a!=b;a=a.parentNode)if(11==a.nodeType&&a.host&&(a=a.host),c=X(a,"position"),d=d&&"static"==c&&a!=b.documentElement&&a!=b.body,!d&&(a.scrollWidth>a.clientWidth||a.scrollHeight>a.clientHeight||"fixed"==c||"absolute"==c||"relative"==c))return a;return null}
function tc(a){for(var b=new H(0,Infinity,Infinity,0),c=P(a),d=c.a.body,e=c.a.documentElement,f=Cb(c.a);a=sc(a);)if(!(J&&0==a.clientWidth||L&&0==a.clientHeight&&a==d)&&a!=d&&a!=e&&"visible"!=X(a,"overflow")){var g=Y(a),h=new G(a.clientLeft,a.clientTop);g.x+=h.x;g.y+=h.y;b.top=Math.max(b.top,g.y);b.right=Math.min(b.right,g.x+a.clientWidth);b.bottom=Math.min(b.bottom,g.y+a.clientHeight);b.left=Math.max(b.left,g.x)}d=f.scrollLeft;f=f.scrollTop;b.left=Math.max(b.left,d);b.top=Math.max(b.top,f);c=(Db(c.a)||
window).document;c="CSS1Compat"==c.compatMode?c.documentElement:c.body;c=new A(c.clientWidth,c.clientHeight);b.right=Math.min(b.right,d+c.width);b.bottom=Math.min(b.bottom,f+c.height);return 0<=b.top&&0<=b.left&&b.bottom>b.top&&b.right>b.left?b:null}function Y(a){var b=Q(a),c=new G(0,0),d;d=b?Q(b):document;d=!J||O(9)||Hb(P(d))?d.documentElement:d.body;if(a==d)return c;a=rc(a);b=P(b);b=Bb(b.a);c.x=a.left+b.x;c.y=a.top+b.y;return c}function uc(a){"number"==typeof a&&(a=a+"px");return a}
function vc(a){var b=wc;if("none"!=X(a,"display"))return b(a);var c=a.style,d=c.display,e=c.visibility,f=c.position;c.visibility="hidden";c.position="absolute";c.display="inline";a=b(a);c.display=d;c.position=f;c.visibility=e;return a}function wc(a){var b=a.offsetWidth,c=a.offsetHeight,d=L&&!b&&!c;return(void 0===b||d)&&a.getBoundingClientRect?(a=rc(a),new A(a.right-a.left,a.bottom-a.top)):new A(b,c)}var xc=K?"MozUserSelect":L?"WebkitUserSelect":null;
function yc(a){var b=a.getElementsByTagName("*");if(xc){var c="none";a.style[xc]=c;if(b){a=0;for(var d;d=b[a];a++)d.style[xc]=c}}else if(J||nb)if(c="on",a.setAttribute("unselectable",c),b)for(a=0;d=b[a];a++)d.setAttribute("unselectable",c)}function zc(a,b){if(/^\d+px?$/.test(b))return parseInt(b,10);var c=a.style.left,d=a.runtimeStyle.left;a.runtimeStyle.left=a.currentStyle.left;a.style.left=b;var e=a.style.pixelLeft;a.style.left=c;a.runtimeStyle.left=d;return e}
function Ac(a,b){var c=a.currentStyle?a.currentStyle[b]:null;return c?zc(a,c):0}var Bc={thin:2,medium:4,thick:6};function Cc(a,b){if("none"==(a.currentStyle?a.currentStyle[b+"Style"]:null))return 0;var c=a.currentStyle?a.currentStyle[b+"Width"]:null;return c in Bc?Bc[c]:zc(a,c)}
function Dc(a){if(J&&!O(9)){var b=Cc(a,"borderLeft"),c=Cc(a,"borderRight"),d=Cc(a,"borderTop");a=Cc(a,"borderBottom");return new H(d,c,a,b)}b=W(a,"borderLeftWidth");c=W(a,"borderRightWidth");d=W(a,"borderTopWidth");a=W(a,"borderBottomWidth");return new H(parseFloat(d),parseFloat(c),parseFloat(a),parseFloat(b))};function Ec(a,b){return(b&4&&"rtl"==X(a,"direction")?b^2:b)&-5};function Fc(a,b){U.call(this);this.c=a||1;this.b=b||n;this.j=u(this.o,this);this.m=ha()}v(Fc,U);Fc.prototype.h=!1;Fc.prototype.a=null;Fc.prototype.o=function(){if(this.h){var a=ha()-this.m;0<a&&a<.8*this.c?this.a=this.b.setTimeout(this.j,this.c-a):(this.a&&(this.b.clearTimeout(this.a),this.a=null),V(this,Gc),this.h&&(this.a=this.b.setTimeout(this.j,this.c),this.m=ha()))}};var Gc="tick";function Hc(a,b,c){U.call(this);this.v=a;this.J=c;this.c=b;S(b,[Ic,Jc,Kc,Lc],this.handleEvent,!1,this);this.m=null;this.b=[];this.h=-1;this.a=0;this.j=this.o=null;this.K={}}v(Hc,U);Hc.prototype.D=10;var Ic="hilite",Jc="select",Lc="dismiss",Kc="canceldismiss";l=Hc.prototype;
l.handleEvent=function(a){var b=this.v;if(a.target==this.c)switch(a.type){case Ic:this.B(a.C);break;case Jc:var c=!1;if("number"==typeof a.C){a=a.C;var d=this.b[Mc(this,a)],c=!!d&&b.U&&b.U(d);d&&!c&&this.h!=a&&this.B(a)}c||Nc(this);break;case Kc:Oc(this);break;case Lc:Pc(this)}};function Qc(a){for(var b=a.a+a.b.length-1,c=a.h,d=0;d<a.b.length;d++){if(c>=a.a&&c<b)c++;else if(-1==c)c=a.a;else break;if(a.B(c))break}}
l.B=function(a){var b=Mc(this,a),c=this.b[b];return c&&this.v.U&&this.v.U(c)?!1:(this.h=a,this.c.B(a),-1!=b)};
function Nc(a){var b=Mc(a,a.h);if(-1!=b){var c=a.b[b],d=a.J;if(d.g){var e=c.toString();if(d.c){var f=Rc(d,d.g.value,Lb(d.g)[0]),g=Sc(d,d.g.value);d.S.test(e)||(e=e.replace(/[\s\xa0]+$/,"")+d.v);0==f||/^[\s\xa0]*$/.test(g[f-1])||(e=" "+e);f==g.length-1&&(e+=" ");if(e!=g[f]){g[f]=e;e=d.g;(K||J&&N("9"))&&e.blur();e.value=g.join("");for(var h=0,k=0;k<=f;k++)h+=g[k].length;e.focus();f=h;g=d.g;e=f;Mb(g)?g.selectionStart=e:J&&(h=Nb(g),k=h[0],k.inRange(h[1])&&(e=Ob(g,e),k.collapse(!0),k.move("character",
e),k.select()));g=d.g;Mb(g)?g.selectionEnd=f:J&&(h=Nb(g),e=h[1],h[0].inRange(e)&&(f=Ob(g,f),g=Ob(g,Lb(g)[0]),e.collapse(!0),e.moveEnd("character",f-g),e.select()))}}else d.R(e);d.Y=!0}a.u();V(a,{type:"update",C:c,index:b});return!0}a.u();V(a,{type:"update",C:null,index:null});return!1}l.u=function(){this.h=-1;this.m=null;this.a+=this.b.length;this.b=[];window.clearTimeout(this.j);this.j=null;this.c.u();V(this,"suggestionsupdate");V(this,Lc)};
function Pc(a){a.j||(a.j=window.setTimeout(u(a.u,a),100))}l.aa=function(){return this.j?(window.clearTimeout(this.j),this.j=null,!0):!1};function Oc(a){a.aa()||window.setTimeout(u(a.aa,a),10)}l.Ba=function(a,b,c){this.m==a&&this.X(b,c)};
l.X=function(a,b){var c="object"==q(b)&&b,d=(c?c.Fa():b)?Mc(this,this.h):-1;this.a+=this.b.length;this.b=a;for(var e=[],f=0;f<a.length;++f)e.push({id:this.a+f,data:a[f]});f=null;if(this.o){var f=this.K,g;g=this.o;g=g[ca]||(g[ca]=++ea);f=f[g]||this.o}this.c.na=f;this.c.X(e,this.m,this.o);f=!0;c&&void 0!==c.ua()&&(f=c.ua());this.h=-1;(f||0<=d)&&0!=e.length&&this.m&&(0<=d?this.B(this.a+d):Qc(this));V(this,"suggestionsupdate")};function Mc(a,b){var c=b-a.a;return 0>c||c>=a.b.length?-1:c}l.update=function(a){this.J.update(a)};function Tc(a,b,c,d){U.call(this);this.v=a||document.body;this.j=P(this.v);this.qa=!a;this.b=null;this.D="";this.c=[];this.h=[];this.J=this.o=-1;this.l=!1;this.className="ac-renderer";this.oa="ac-highlighted";this.m=b||null;this.sa=null!=d?d:!0;this.ra=!!c}v(Tc,U);l=Tc.prototype;l.X=function(a,b,c){this.D=b;this.c=a;this.o=-1;this.J=ha();this.a=c;this.h=[];Uc(this)};l.u=function(){this.a&&Kb(this.a,null);this.l&&(this.l=!1,this.a&&Jb(this.a,"haspopup",!1),this.b.style.display="none")};
function Vc(a){a.l||(a.l=!0,a.a&&(Ib(a.a,"combobox"),Jb(a.a,"autocomplete","list"),Jb(a.a,"haspopup",!0)),a.b.style.display="")}
function Wc(a,b){var c=0<=b&&b<a.c.length?a.c[b]:void 0,d=0<=b&&b<a.h.length?a.h[b]:void 0;if(V(a,{type:"rowhilite",Ia:d,C:c?c.data:null})&&(0<=a.o&&Za(a.h[a.o]),a.o=b,d)){Xa(d,["ac-active","active"]);a.a&&Kb(a.a,d);var c=a.b,e,f=Y(d);e=Y(c);var g=Dc(c),h=f.x-e.x-g.left,f=f.y-e.y-g.top,k=c.clientWidth-d.offsetWidth,d=c.clientHeight-d.offsetHeight,m=c.scrollLeft,p=c.scrollTop;if(c==document.body||c==document.documentElement)m=e.x+g.left,p=e.y+g.top,J&&!O(10)&&(m+=g.left,p+=g.top);m+=Math.min(h,Math.max(h-
k,0));p+=Math.min(f,Math.max(f-d,0));e=new G(m,p);c.scrollLeft=e.x;c.scrollTop=e.y}}l.B=function(a){if(-1==a)Wc(this,-1);else for(var b=0;b<this.c.length;b++)if(this.c[b].id==a){Wc(this,b);break}};function Xc(a){if(!a.b){var b=a.j.b("DIV",{style:"display:none"});a.b=b;Xa(b,ua(a.className).split(" "));Ib(b,"listbox");b.id=":"+(I.a().a++).toString(36);a.v.appendChild(b);S(b,"click",a.xa,!1,a);S(b,"mousedown",a.za,!1,a);S(b,"mouseover",a.Aa,!1,a)}}
function Uc(a){Xc(a);a.ta&&(a.b.style.minWidth=a.ta.clientWidth+"px");a.h.length=0;a.j.f(a.b);a.m&&a.m.Ga||C(a.c,function(a){var c=a;a=this.D;var d=this.j.b("DIV",{className:"ac-row",id:":"+(I.a().a++).toString(36)});Ib(d,"option");if(!this.m||!this.m.Ha)if(c=c.data.toString(),"textContent"in d)d.textContent=c;else if(3==d.nodeType)d.data=c;else if(d.firstChild&&3==d.firstChild.nodeType){for(;d.lastChild!=d.firstChild;)d.removeChild(d.lastChild);d.firstChild.data=c}else Fb(d),d.appendChild(Q(d).createTextNode(String(c)));
a&&this.sa&&(this.K=!1,Yc(this,d,a));Wa(d,"ac-row");this.h.push(d);this.b.appendChild(d)},a);0==a.c.length?a.u():(Vc(a),Zc(a),yc(a.b))}
function Zc(a){if(a.a&&a.qa){var b=a.na||a.a,c;c=a.ra?3:1;a=a.b;var d=c^1,e,f;if(e=a.offsetParent){var g="HTML"==e.tagName||"BODY"==e.tagName;g&&"static"==X(e,"position")||(f=Y(e),g||(g=(g="rtl"==X(e,"direction"))&&K?-e.scrollLeft:!g||J&&N("8")||"visible"==X(e,"overflowX")?e.scrollLeft:e.scrollWidth-e.clientWidth-e.scrollLeft,f=jb(f,new G(g,e.scrollTop))))}e=f||new G;f=Y(b);g=vc(b);f=new kb(f.x,f.y,g.width,g.height);if(g=tc(b)){var h=new kb(g.left,g.top,g.right-g.left,g.bottom-g.top),g=Math.max(f.left,
h.left),k=Math.min(f.left+f.width,h.left+h.width);if(g<=k){var m=Math.max(f.top,h.top),h=Math.min(f.top+f.height,h.top+h.height);m<=h&&(f.left=g,f.top=m,f.width=k-g,f.height=h-m)}}g=P(b);m=P(a);if(g.a!=m.a){var k=g.a.body,m=Db(m.a),h=new G(0,0),p;p=(p=Q(k))?Db(p):window;var w=k;do{var x;p==m?x=Y(w):(x=rc(w),x=new G(x.left,x.top));h.x+=x.x;h.y+=x.y}while(p&&p!=m&&p!=p.parent&&(w=p.frameElement)&&(p=p.parent));k=jb(h,Y(k));!J||O(9)||Hb(g)||(k=jb(k,Bb(g.a)));f.left+=k.x;f.top+=k.y}b=Ec(b,c);c=new G(b&
2?f.left+f.width:f.left,b&1?f.top+f.height:f.top);c=jb(c,e);if(b=tc(a))b.top-=e.y,b.right-=e.x,b.bottom-=e.y,b.left-=e.x;c=c.clone();f=Ec(a,d);d=vc(a);e=d.clone();c=c.clone();e=e.clone();0!=f&&(f&2&&(c.x-=e.width+0),f&1&&(c.y-=e.height+0));b?(f=c,g=e,k=65,m=0,65==(k&65)&&(f.x<b.left||f.x>=b.right)&&(k&=-2),132==(k&132)&&(f.y<b.top||f.y>=b.bottom)&&(k&=-5),f.x<b.left&&k&1&&(f.x=b.left,m|=1),k&16&&(h=f.x,f.x<b.left&&(f.x=b.left,m|=4),f.x+g.width>b.right&&(g.width=Math.min(b.right-f.x,h+g.width-b.left),
g.width=Math.max(g.width,0),m|=4)),f.x+g.width>b.right&&k&1&&(f.x=Math.max(b.right-g.width,b.left),m|=1),k&2&&(m=m|(f.x<b.left?16:0)|(f.x+g.width>b.right?32:0)),f.y<b.top&&k&4&&(f.y=b.top,m|=2),k&32&&(h=f.y,f.y<b.top&&(f.y=b.top,m|=8),f.y+g.height>b.bottom&&(g.height=Math.min(b.bottom-f.y,h+g.height-b.top),g.height=Math.max(g.height,0),m|=8)),f.y+g.height>b.bottom&&k&4&&(f.y=Math.max(b.bottom-g.height,b.top),m|=2),k&8&&(m=m|(f.y<b.top?64:0)|(f.y+g.height>b.bottom?128:0)),f=m):f=256;b=new kb(0,0,0,
0);b.left=c.x;b.top=c.y;b.width=e.width;b.height=e.height;f&496||(e=new G(b.left,b.top),e instanceof G?(c=e.x,e=e.y):(c=e,e=void 0),a.style.left=uc(c),a.style.top=uc(e),e=new A(b.width,b.height),d==e||d&&e&&d.width==e.width&&d.height==e.height||(d=e,c=Hb(P(Q(a))),!J||N("10")||c&&N("8")?(a=a.style,K?a.MozBoxSizing="border-box":L?a.WebkitBoxSizing="border-box":a.boxSizing="border-box",a.width=Math.max(d.width,0)+"px",a.height=Math.max(d.height,0)+"px"):(b=a.style,c?(J?(c=Ac(a,"paddingLeft"),e=Ac(a,
"paddingRight"),f=Ac(a,"paddingTop"),g=Ac(a,"paddingBottom"),c=new H(f,e,g,c)):(c=W(a,"paddingLeft"),e=W(a,"paddingRight"),f=W(a,"paddingTop"),g=W(a,"paddingBottom"),c=new H(parseFloat(f),parseFloat(e),parseFloat(g),parseFloat(c))),a=Dc(a),b.pixelWidth=d.width-a.left-c.left-c.right-a.right,b.pixelHeight=d.height-a.top-c.top-c.bottom-a.bottom):(b.pixelWidth=d.width,b.pixelHeight=d.height))))}}
function Yc(a,b,c){if(!a.K)if(3==b.nodeType){var d=null;r(c)&&1<c.length&&(d=Ka(c,1));c=$c(c);if(0!=c.length){var e=b.nodeValue,f=new RegExp("\\b(?:"+c+")","gi");c=[];for(var g=0,h=f.exec(e),k=0;h;)k++,c.push(e.substring(g,h.index)),c.push(e.substring(h.index,f.lastIndex)),g=f.lastIndex,h=f.exec(e);c.push(e.substring(g));if(1<c.length){for(d=0;1>d;d++)e=2*d,b.nodeValue=c[e],f=a.j.a.createElement("B"),f.className=a.oa,f.appendChild(a.j.a.createTextNode(String(c[e+1]))),f=b.parentNode.insertBefore(f,
...
l.xa=function(a){var b=ad(this,a.target);0<=b&&V(this,{type:Jc,C:this.c[b].id});a.stopPropagation()};l.za=function(a){a.stopPropagation();a.preventDefault()};l.Aa=function(a){a=ad(this,a.target);0<=a&&!(300>ha()-this.J)&&V(this,{type:Ic,C:this.c[a].id})};var bd=E("iPhone")&&!E("iPod")&&!E("iPad")||E("iPod"),cd=E("iPad");!E("Android")||ib()||E("Firefox")||gb();ib();function dd(a,b,c,d){y.call(this);d=d||150;this.c=null!=c?c:!0;this.i=a||",;";this.v=this.i.substring(0,1);a=this.c?"[\\s"+this.i+"]+":"[\\s]+";this.o=new RegExp("^"+a+"|"+a+"$","g");this.S=new RegExp("\\s*["+this.i+"]$");this.m=b||"";this.D=this.c;this.f=0<d?new Fc(d):null;this.b=new cc(this);this.h=new cc(this);this.l=new jc;this.j=-1}v(dd,y);var ed=(bd||cd)&&!N("533.17.9");l=dd.prototype;l.g=null;l.W="";l.A=!1;l.Y=!1;l.R=function(a){this.g.value=a};
l.va=function(a){for(var b=0;b<arguments.length;b++){var c=arguments[b];ba(c)&&1==c.nodeType&&Jb(c,"haspopup",!0);this.b.f(c,"focus",this.$);this.b.f(c,"blur",this.wa);if(!this.g&&(this.h.f(c,"keydown",this.Ca),ba(c)&&1==c.nodeType)){var d;a:{var e=Q(c);try{d=e&&e.activeElement;break a}catch(f){}d=null}d==c&&fd(this,c)}}};
function gd(a,b){switch(b.keyCode){case 40:if(a.a.c.l){Qc(a.a);b.preventDefault();return}if(!a.c){a.update(!0);b.preventDefault();return}break;case 38:if(a.a.c.l){a:for(var c=a.a,d=c.h,e=0;e<c.b.length;e++){if(d>c.a)d--;else break;if(c.B(d))break a}b.preventDefault();return}break;case 9:if(!a.a.c.l||b.l)a.a.u();else if(a.update(),Nc(a.a)&&a.D){b.preventDefault();return}break;case 13:if(a.a.c.l){if(a.update(),Nc(a.a)){b.preventDefault();b.stopPropagation();return}}else a.a.u();break;case 27:if(a.a.c.l){a.a.u();
b.preventDefault();b.stopPropagation();return}break;case 229:if(!a.A){a.A||(a.b.f(a.g,"keyup",a.da),a.b.f(a.g,"keypress",a.ca),a.A=!0);return}}hd(a,b)}function hd(a,b){var c=a.c&&b.i&&-1!=a.i.indexOf(String.fromCharCode(b.i));c&&a.update();c&&Nc(a.a)&&b.preventDefault()}l.ya=function(){return!1};l.$=function(a){fd(this,a.target||null)};
function fd(a,b){var c=a.h;pa(c.a,T);c.a={};a.a&&Oc(a.a);b!=a.g&&(a.g=b,a.f&&(c=a.f,c.h=!0,c.a||(c.a=c.b.setTimeout(c.j,c.c),c.m=ha()),a.b.f(a.f,Gc,a.ga)),a.W=a.g.value,kc(a.l,a.g),a.b.f(a.l,"key",a.ea),a.b.f(a.g,"mousedown",a.fa),J&&a.b.f(a.g,"keypress",a.ba))}l.wa=function(){ed?window.setTimeout(u(this.ha,this),0):this.ha()};
l.ha=function(){if(this.g){this.b.i(this.l,"key",this.ea);qc(this.l);this.b.i(this.g,"keyup",this.ya);this.b.i(this.g,"mousedown",this.fa);J&&this.b.i(this.g,"keypress",this.ba);this.A&&id(this);this.g=null;if(this.f){var a=this.f;a.h=!1;a.a&&(a.b.clearTimeout(a.a),a.a=null);this.b.i(this.f,Gc,this.ga)}this.a&&Pc(this.a)}};l.ga=function(){this.update()};l.Ca=function(a){this.$(a)};l.ea=function(a){this.j=a.keyCode;this.a&&gd(this,a)};l.ca=function(){this.A&&229!=this.j&&id(this)};
l.da=function(a){this.A&&(13==a.keyCode||77==a.keyCode&&a.ctrlKey)&&id(this)};l.fa=function(){};function id(a){a.A&&(a.A=!1,a.b.i(a.g,"keypress",a.ca),a.b.i(a.g,"keyup",a.da))}l.ba=function(a){hd(this,a)};
l.update=function(a){if(this.g&&(a||this.g.value!=this.W)){if(a||!this.Y){var b;a=Lb(this.g)[0];b=this.g.value;a=Sc(this,b)[Rc(this,b,a)];b=this.o?String(a).replace(this.o,""):a;if(this.a&&(this.a.o=this.g,a=this.a,a.m!=b)){a.m=b;var c=a.v;b=a.m;var d=a.D,e=u(a.Ba,a),c=c.a,f;f=[];if(""!=b)for(var g=Da(b),g=new RegExp("(^|\\W+)"+g,"i"),h=0;h<c.length&&f.length<d;h++){var k=c[h];String(k).match(g)&&f.push(k)}0==f.length&&(f=mb(b,d,c));e(b,f);Oc(a)}}this.W=this.g.value}this.Y=!1};
function Rc(a,b,c){a=Sc(a,b);if(c==b.length)return a.length-1;for(var d=b=0,e=0;d<a.length&&e<=c;d++)e+=a[d].length,b=d;return b}function Sc(a,b){if(!a.c)return[b];for(var c=String(b).split(""),d=[],e=[],f=0,g=!1;f<c.length;f++)a.m&&-1!=a.m.indexOf(c[f])?(g||(d.push(e.join("")),e.length=0),e.push(c[f]),g=!g):g||-1==a.i.indexOf(c[f])?e.push(c[f]):(e.push(c[f]),d.push(e.join("")),e.length=0);d.push(e.join(""));return d};function jd(a,b){var c=new lb(a),d=new Tc,e=new dd(null,null,!1),c=new Hc(c,d,e);e.a=c;e.va(b);return c};function kd(){var a=n.TYPES;ld(a);md(a);nd()}var od=["init"],Z=n;od[0]in Z||!Z.execScript||Z.execScript("var "+od[0]);for(var pd;od.length&&(pd=od.shift());)od.length||void 0===kd?Z[pd]?Z=Z[pd]:Z=Z[pd]={}:Z[pd]=kd;var Ta=function(){var a="";Ha(document.querySelectorAll("script"),function(b){b=b.getAttribute("src");var c=b.length;return"dossier.js"===b.slice(c-10)?(a=b.slice(0,c-10),!0):!1});return a}();
function nd(){function a(a){a=Gb(a,function(a){return"TR"===a.nodeName});Wa(a,"hilite")}var b=document.querySelector("article.srcfile table");if(b){if(location.hash){var c=document.querySelector("tr > td a"+location.hash);c&&a(c)}S(window,"hashchange",function(){C(b.querySelectorAll("tr.hilite"),function(a){Ya(a,"hilite")});var c=b.querySelector("tr > td a:target");c&&a(c)})}}
function ld(a){function b(){var a=c[e.value];a&&(window.location.href=Ta+a)}var c={},d=[];a.types&&C(a.types,function(a){qd(d,c,a)});a.modules&&C(a.modules,function(a){qd(d,c,a,!0)});a=document.querySelector("header form");S(a,"submit",function(a){a.preventDefault();a.stopPropagation();b();return!1});var e=a.querySelector("input");e.setAttribute("title","Search ("+(M?"⌘":"Ctrl+")+"E)");a=jd(d,e);a.D=20;S(a,"update",b);S(document.documentElement,"keydown",function(a){if(document.activeElement!==e&&
69===a.keyCode&&(M?a.metaKey:a.ctrlKey))return e.focus(),a.preventDefault(),a.stopPropagation(),!1;document.activeElement===e&&27===a.keyCode&&e.blur()})}
function qd(a,b,c,d,e){var f=c.name;e&&(f=e+(ta(e,")")?" ":".")+f);b[f]=c.href;a.push(f);d&&(f="("+f+")");d&&c.types&&C(c.types,function(c){qd(a,b,c,!1,f)});c.statics&&C(c.statics,function(d){var e=c.href+"#"+d;d=ta(f,")")?f+" "+d:-1===d.indexOf(".")?f+"."+d:f+d.slice(d.lastIndexOf("."));b[d]=e;a.push(d)});c.members&&C(c.members,function(d){b[f+"#"+d]=c.href+"#"+d;a.push(f+"#"+d)})}
function md(a){function b(a){window.localStorage&&window.localStorage.setItem(a.id,a.checked?"closed":"open")}var c="";Ta?c=window.location.pathname.split("/").slice(Ta.split("/").length).join("/"):window.location.pathname&&"/"!==window.location.pathname&&(c=window.location.pathname.slice(window.location.pathname.lastIndexOf("/")+1));var d=yb("nav-types-view");d&&a.types&&d.appendChild(Sa(a.types,c,!1));(d=yb("nav-modules-view"))&&a.modules&&d.appendChild(Sa(a.modules,c,!0));a=document.querySelector("nav");
S(a,"keydown",function(a){if(37===a.keyCode||39===a.keyCode||32===a.keyCode){var c=Gb(a.target,function(a){return"LABEL"===a.tagName});c&&(c=document.getElementById(c.getAttribute("for")))&&(32===a.keyCode?(c.checked=!c.checked,a.preventDefault()):c.checked=37===a.keyCode,b(c))}});S(a,["focus","blur"],function(a){if(a.target.classList.contains("nav-item")&&"LABEL"===a.target.parentNode.tagName){var b=a.target.parentNode;"focus"===a.type?b.classList.add("focused"):b.classList.remove("focused")}},!0);
window.localStorage&&(C(a.querySelectorAll('input[type="checkbox"][id]'),function(a){var b=window.localStorage.getItem(a.id);a.checked=!t(b)||"closed"===b}),S(a,"change",function(a){b(a.target)}))};;init();})();
