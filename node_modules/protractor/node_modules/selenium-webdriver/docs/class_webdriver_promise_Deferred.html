...
<h3>new Deferred(<wbr>opt_flow)</h3><div><div class="fn-details"><div><b>Parameters</b></div><dl><dt>opt_flow<code>?<a href="class_webdriver_promise_ControlFlow.html">webdriver.promise.ControlFlow</a>=</code><dd><p>The control flow this instance was
created under. This should only be provided during unit tests.</p>
</dl></div></div><h2>Instance Methods</h2><div id="cancel" class="function"><div><h3>cancel(<wbr>opt_reason)<span class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l1410">code »</a></span></h3><p>Cancels the computation of this promise&#39;s value, rejecting the promise in
...
</dl></div></div></div></div><hr class="fn-sep"><div id="fulfill" class="function"><div><h3>fulfill(<wbr>opt_value)<span class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l1388">code »</a></span></h3><p>Resolves this deferred with the given value. It is safe to call this as a
...
</dl></div></div></div></div><hr class="fn-sep"><div id="isPending" class="function"><div><h3>isPending()<span class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l1405">code »</a></span></h3><p><b>Specified by: </b><a href="interface_webdriver_promise_Thenable.html#isPending">webdriver.promise.Thenable</a></p><div><div class="fn-details"><div><b>Returns</b></div><dl><dt><code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean">boolean</a></code><dd><p>Whether this promise&#39;s value is still being computed.</p>
</dl></div></div></div></div><hr class="fn-sep"><div id="reject" class="function"><div><h3>reject(<wbr>opt_reason)<span class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l1398">code »</a></span></h3><p>Rejects this promise with the given reason. It is safe to call this as a
normal function (with no bound &#34;this&#34;).</p>
<div><div class="fn-details"><div><b>Parameters</b></div><dl><dt>opt_reason<code>*=</code><dd><p>The rejection reason.</p>
</dl></div></div></div></div><hr class="fn-sep"><div id="then" class="function"><div><h3>then(<wbr>opt_callback, opt_errback)<span class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l1418">code »</a></span></h3><div class="tags"><span>deprecated</span></div><p>Registers listeners for when this instance is resolved.</p>
...
</dl></div></div></div></div><hr class="fn-sep"><div id="thenCatch" class="function"><div><h3>thenCatch(<wbr>errback)<span class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l1426">code »</a></span></h3><div class="tags"><span>deprecated</span></div><p>Registers a listener for when this promise is rejected. This is synonymous
...
resolved with the result of the invoked callback.</p>
</dl></div></div></div></div><hr class="fn-sep"><div id="thenFinally" class="function"><div><h3>thenFinally(<wbr>callback)<span class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l1434">code »</a></span></h3><div class="tags"><span>deprecated</span></div><p>Registers a listener to invoke when this promise is resolved, regardless
