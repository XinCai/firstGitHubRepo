<!DOCTYPE html><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, user-scalable=no"><meta http-equiv="Content-Language" content="en"><meta http-equiv="X-UA-Compatible" content="IE=edge"><title>Driver</title><link href="dossier.css" rel="stylesheet" type="text/css"><header><div><form><div><input type="search" placeholder="Search" tabindex="1"></div></form></div></header><main><article><div class="parentlink"><b>Module:</b> <a href="module_selenium-webdriver_ie.html">selenium-webdriver/ie</a></div><div class="codelink"><a href="source/ie.js.src.html#l463">View Source</a></div><h1>class Driver</h1><pre class="inheritance"><a href="class_webdriver_WebDriver.html">webdriver.WebDriver</a>
  &#x2514; Driver</pre><p>A WebDriver client for Microsoft&#39;s Internet Explorer.</p>
<h3>new Driver(<wbr>opt_config, opt_flow)</h3><div><div class="fn-details"><div><b>Parameters</b></div><dl><dt>opt_config<code>?(<a href="module_selenium-webdriver_class_Capabilities.html">Capabilities</a>|<a href="module_selenium-webdriver_ie_class_Options.html">Options</a>)=</code><dd><p>The configuration
options.</p>
...
<p>Unlike executing synchronous JavaScript with <a href="module_selenium-webdriver_ie_class_Driver.html#executeScript"><code>#executeScript</code></a>,
...
present on the page, use <a href="module_selenium-webdriver_ie_class_Driver.html#isElementPresent"><code>#isElementPresent</code></a> instead.</p>
...
driver will attempt to retrieve it through <a href="module_selenium-webdriver_ie_class_Driver.html#executeScript"><code>#executeScript</code></a>. If the
...
</dl></div></div></div></div><hr class="fn-sep"><div id="setFileDetector" class="function"><div><h3>setFileDetector(<wbr>detector)<span class="codelink"><a href="source/ie.js.src.html#l456">code »</a></span></h3><p>This function is a no-op as file detectors are not supported by this
implementation.</p>
