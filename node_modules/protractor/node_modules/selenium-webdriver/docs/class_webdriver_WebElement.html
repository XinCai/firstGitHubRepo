<!DOCTYPE html><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, user-scalable=no"><meta http-equiv="Content-Language" content="en"><meta http-equiv="X-UA-Compatible" content="IE=edge"><title>WebElement</title><link href="dossier.css" rel="stylesheet" type="text/css"><header><div><form><div><input type="search" placeholder="Search" tabindex="1"></div></form></div></header><main><article><div class="parentlink"><b>Namespace:</b> <a href="namespace_webdriver.html">webdriver</a></div><div class="codelink"><a href="source/lib/webdriver/webdriver.js.src.html#l1706">View Source</a></div><h1>class WebElement</h1><pre class="inheritance"><a href="class_webdriver_Serializable.html">webdriver.Serializable</a>&lt;{ELEMENT: <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a>}&gt;
  &#x2514; webdriver.WebElement</pre><p>Represents a DOM element. WebElements can be found by searching from the
...
element is present on the page, use <a href="class_webdriver_WebElement.html#isElementPresent"><code>#isElementPresent</code></a> instead.</p>
...
<div><div class="fn-details"><div><b>Parameters</b></div><dl><dt>opt_scroll<code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean">boolean</a>=</code><dd><p>Optional argument that indicates whether the
