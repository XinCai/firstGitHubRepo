<!DOCTYPE html><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, user-scalable=no"><meta http-equiv="Content-Language" content="en"><meta http-equiv="X-UA-Compatible" content="IE=edge"><title>CommandExecutor</title><link href="dossier.css" rel="stylesheet" type="text/css"><header><div><form><div><input type="search" placeholder="Search" tabindex="1"></div></form></div></header><main><article><div class="parentlink"><b>Namespace:</b> <a href="namespace_webdriver.html">webdriver</a></div><div class="codelink"><a href="source/lib/webdriver/command.js.src.html#l235">View Source</a></div><h1>interface CommandExecutor</h1><p>Handles the execution of WebDriver <a href="class_webdriver_Command.html"><code>commands</code></a>.</p>
<h2>Instance Methods</h2><div id="execute" class="function"><div><h3>execute(<wbr>command, callback)<span class="codelink"><a href="source/lib/webdriver/command.js.src.html#l247">code »</a></span></h3><p>Executes the given <code>command</code>. If there is an error executing the
...
<div><div class="fn-details"><div><b>Parameters</b></div><dl><dt>command<code><a href="class_webdriver_Command.html">webdriver.Command</a></code><dd><p>The command to execute.</p>
