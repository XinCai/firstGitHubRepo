<!DOCTYPE html><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, user-scalable=no"><meta http-equiv="Content-Language" content="en"><meta http-equiv="X-UA-Compatible" content="IE=edge"><title>Driver</title><link href="dossier.css" rel="stylesheet" type="text/css"><header><div><form><div><input type="search" placeholder="Search" tabindex="1"></div></form></div></header><main><article><div class="parentlink"><b>Module:</b> <a href="module_selenium-webdriver_safari.html">selenium-webdriver/safari</a></div><div class="codelink"><a href="source/safari.js.src.html#l537">View Source</a></div><h1>class Driver</h1><pre class="inheritance"><a href="class_webdriver_WebDriver.html">webdriver.WebDriver</a>
  &#x2514; Driver</pre><p>A WebDriver client for Safari. This class should never be instantiated
directly; instead, use the <a href="module_selenium-webdriver_class_Builder.html"><code>selenium-webdriver.Builder</code></a>:</p>
<pre><code>var driver &#61; new Builder()
    .forBrowser(&#39;safari&#39;)
    .build();
</code></pre>
<h3>new Driver(<wbr>opt_config, opt_flow)</h3><div><div class="fn-details"><div><b>Parameters</b></div><dl><dt>opt_config<code>?(<a href="module_selenium-webdriver_safari_class_Options.html">Options</a>|<a href="module_selenium-webdriver_class_Capabilities.html">Capabilities</a>)=</code><dd><p>The configuration
options for the new session.</p>
<dt>opt_flow<code>?<a href="class_webdriver_promise_ControlFlow.html">webdriver.promise.ControlFlow</a>=</code><dd><p>The control flow to create
the driver under.</p>
...
<p>Unlike executing synchronous JavaScript with <a href="module_selenium-webdriver_safari_class_Driver.html#executeScript"><code>#executeScript</code></a>,
...
present on the page, use <a href="module_selenium-webdriver_safari_class_Driver.html#isElementPresent"><code>#isElementPresent</code></a> instead.</p>
...
driver will attempt to retrieve it through <a href="module_selenium-webdriver_safari_class_Driver.html#executeScript"><code>#executeScript</code></a>. If the
...
<p><b>Defined by: </b><a href="class_webdriver_WebDriver.html#setFileDetector">webdriver.WebDriver</a></p><div><div class="fn-details"><div><b>Parameters</b></div><dl><dt>detector<code><a href="class_webdriver_FileDetector.html">webdriver.FileDetector</a></code><dd><p>The detector to use or <code>null</code>.</p>
