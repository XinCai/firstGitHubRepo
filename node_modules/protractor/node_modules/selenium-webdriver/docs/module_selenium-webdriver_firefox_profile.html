...
<h2>Functions</h2><div id="decode" class="function"><div><h3>decode(<wbr>data)<span class="codelink"><a href="source/firefox/profile.js.src.html#l432">code »</a></span></h3><p>Decodes a base64 encoded profile.</p>
...
profile directory.</p>
</dl></div></div></div></div><hr class="fn-sep"><div id="loadUserPrefs" class="function"><div><h3>loadUserPrefs(<wbr>f)<span class="codelink"><a href="source/firefox/profile.js.src.html#l433">code »</a></span></h3><p>Parses a user.js file in a Firefox profile directory.</p>
