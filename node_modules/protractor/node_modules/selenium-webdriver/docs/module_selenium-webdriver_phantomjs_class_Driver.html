<!DOCTYPE html><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, user-scalable=no"><meta http-equiv="Content-Language" content="en"><meta http-equiv="X-UA-Compatible" content="IE=edge"><title>Driver</title><link href="dossier.css" rel="stylesheet" type="text/css"><header><div><form><div><input type="search" placeholder="Search" tabindex="1"></div></form></div></header><main><article><div class="parentlink"><b>Module:</b> <a href="module_selenium-webdriver_phantomjs.html">selenium-webdriver/phantomjs</a></div><div class="codelink"><a href="source/phantomjs.js.src.html#l265">View Source</a></div><h1>class Driver</h1><pre class="inheritance"><a href="class_webdriver_WebDriver.html">webdriver.WebDriver</a>
  &#x2514; Driver</pre><p>Creates a new WebDriver client for PhantomJS.</p>
<h3>new Driver(<wbr>opt_capabilities, opt_flow)</h3><div><div class="fn-details"><div><b>Parameters</b></div><dl><dt>opt_capabilities<code>?<a href="module_selenium-webdriver_class_Capabilities.html">Capabilities</a>=</code><dd><p>The desired capabilities.</p>
<dt>opt_flow<code>?<a href="class_webdriver_promise_ControlFlow.html">webdriver.promise.ControlFlow</a>=</code><dd><p>The control flow to use, or
<code>null</code> to use the currently active flow.</p>
...
<p>Unlike executing synchronous JavaScript with <a href="module_selenium-webdriver_phantomjs_class_Driver.html#executeScript"><code>#executeScript</code></a>,
...
</dl></div></div></div></div><hr class="fn-sep"><div id="executePhantomJS" class="function"><div><h3><code>&lt;T&gt;</code> executePhantomJS(<wbr>script, var_args)<span class="codelink"><a href="source/phantomjs.js.src.html#l249">code »</a></span></h3><p>Executes a PhantomJS fragment. This method is similar to
<a href="module_selenium-webdriver_phantomjs_class_Driver.html#executeScript"><code>#executeScript</code></a>, except it exposes the
...
<code>page</code> variable. If a page has not been loaded before calling this
...
<p>As with <a href="module_selenium-webdriver_phantomjs_class_Driver.html#executeScript"><code>#executeScript</code></a>, the injected script may be defined as
...
that the function does not override <code>Function.prototype.toString</code>
...
<dt>var_args<code>...*</code><dd><p>The arguments to pass to the script.</p>
</dl></div><div class="fn-details"><div><b>Returns</b></div><dl><dt><code><a href="class_webdriver_promise_Promise.html">webdriver.promise.Promise</a></code><dd><p>A promise that resolve to the
script&#39;s return value.</p>
...
present on the page, use <a href="module_selenium-webdriver_phantomjs_class_Driver.html#isElementPresent"><code>#isElementPresent</code></a> instead.</p>
...
driver will attempt to retrieve it through <a href="module_selenium-webdriver_phantomjs_class_Driver.html#executeScript"><code>#executeScript</code></a>. If the
...
</dl></div></div></div></div><hr class="fn-sep"><div id="setFileDetector" class="function"><div><h3>setFileDetector(<wbr>detector)<span class="codelink"><a href="source/phantomjs.js.src.html#l211">code »</a></span></h3><p>This function is a no-op as file detectors are not supported by this
implementation.</p>
