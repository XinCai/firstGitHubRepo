<!DOCTYPE html><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, user-scalable=no"><meta http-equiv="Content-Language" content="en"><meta http-equiv="X-UA-Compatible" content="IE=edge"><title>Driver</title><link href="dossier.css" rel="stylesheet" type="text/css"><header><div><form><div><input type="search" placeholder="Search" tabindex="1"></div></form></div></header><main><article><div class="parentlink"><b>Module:</b> <a href="module_selenium-webdriver_chrome.html">selenium-webdriver/chrome</a></div><div class="codelink"><a href="source/chrome.js.src.html#l844">View Source</a></div><h1>class Driver</h1><pre class="inheritance"><a href="class_webdriver_WebDriver.html">webdriver.WebDriver</a>
  &#x2514; Driver</pre><p>Creates a new WebDriver client for Chrome.</p>
<h3>new Driver(<wbr>opt_config, opt_service, opt_flow)</h3><div><div class="fn-details"><div><b>Parameters</b></div><dl><dt>opt_config<code>?(<a href="module_selenium-webdriver_class_Capabilities.html">Capabilities</a>|<a href="module_selenium-webdriver_chrome_class_Options.html">Options</a>)=</code><dd><p>The configuration
options.</p>
<dt>opt_service<code>?<a href="module_selenium-webdriver_remote_class_DriverService.html">DriverService</a>=</code><dd><p>The session to use; will use
the default service by default.</p>
...
<p>Unlike executing synchronous JavaScript with <a href="module_selenium-webdriver_chrome_class_Driver.html#executeScript"><code>#executeScript</code></a>,
...
present on the page, use <a href="module_selenium-webdriver_chrome_class_Driver.html#isElementPresent"><code>#isElementPresent</code></a> instead.</p>
...
driver will attempt to retrieve it through <a href="module_selenium-webdriver_chrome_class_Driver.html#executeScript"><code>#executeScript</code></a>. If the
...
</dl></div></div></div></div><hr class="fn-sep"><div id="launchApp" class="function"><div><h3>launchApp(<wbr>id)<span class="codelink"><a href="source/chrome.js.src.html#l834">code »</a></span></h3><p>Schedules a command to launch Chrome App with given ID.</p>
<div><div class="fn-details"><div><b>Parameters</b></div><dl><dt>id<code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a></code><dd><p>ID of the App to launch.</p>
</dl></div><div class="fn-details"><div><b>Returns</b></div><dl><dt><code><a href="class_webdriver_promise_Promise.html">webdriver.promise.Promise</a></code><dd><p>A promise that will be resolved
when app is launched.</p>
...
</dl></div></div></div></div><hr class="fn-sep"><div id="setFileDetector" class="function"><div><h3>setFileDetector(<wbr>detector)<span class="codelink"><a href="source/chrome.js.src.html#l824">code »</a></span></h3><p>This function is a no-op as file detectors are not supported by this
implementation.</p>
