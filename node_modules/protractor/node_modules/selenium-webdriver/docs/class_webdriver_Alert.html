...
</dl></div></div><h2>Instance Methods</h2><div id="accept" class="function"><div><h3>accept()<span class="codelink"><a href="source/lib/webdriver/webdriver.js.src.html#l2327">code »</a></span></h3><p>Accepts this alert.</p>
...
</dl></div></div></div></div><hr class="fn-sep"><div id="dismiss" class="function"><div><h3>dismiss()<span class="codelink"><a href="source/lib/webdriver/webdriver.js.src.html#l2339">code »</a></span></h3><p>Dismisses this alert.</p>
<div><div class="fn-details"><div><b>Returns</b></div><dl><dt><code><a href="class_webdriver_promise_Promise.html">webdriver.promise.Promise</a>&lt;<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Undefined">undefined</a>&gt;</code><dd><p>A promise that will be resolved
when this command has completed.</p>
</dl></div></div></div></div><hr class="fn-sep"><div id="getText" class="function"><div><h3>getText()<span class="codelink"><a href="source/lib/webdriver/webdriver.js.src.html#l2317">code »</a></span></h3><p>Retrieves the message text displayed with this alert. For instance, if the
...
</dl></div></div></div></div><hr class="fn-sep"><div id="sendKeys" class="function"><div><h3>sendKeys(<wbr>text)<span class="codelink"><a href="source/lib/webdriver/webdriver.js.src.html#l2354">code »</a></span></h3><p>Sets the response text on this alert. This command will return an error if
