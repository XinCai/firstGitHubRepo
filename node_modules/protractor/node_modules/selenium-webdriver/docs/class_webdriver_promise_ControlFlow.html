...
<p>Refer to the <a href="namespace_webdriver_promise.html"><code>webdriver.promise</code></a> module documentation for a detailed
...
</dl></div></div></div></div><hr class="fn-sep"><div id="async" class="function"><div><h3>async(<wbr>fn, opt_self, var_args)<span class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l2288">code »</a></span></h3><p>Executes a function in the next available turn of the JavaScript event
...
<div><div class="fn-details"><div><b>Parameters</b></div><dl><dt>fn<code>Function</code><dd><p>The function to execute.</p>
<dt>opt_self<code>?<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object">Object</a>=</code><dd><p>The object in whose context to run the function.</p>
...
</dl></div></div></div></div><hr class="fn-sep"><div id="execute" class="function"><div><h3><code>&lt;T&gt;</code> execute(<wbr>fn, opt_description)<span class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l2111">code »</a></span></h3><p>Schedules a task for execution. If there is nothing currently in the
...
</dl></div></div></div></div><hr class="fn-sep"><div id="getSchedule" class="function"><div><h3>getSchedule(<wbr>opt_includeStackTraces)<span class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l2023">code »</a></span></h3><p>Generates an annotated string describing the internal state of this control
...
</dl></div></div></div></div><hr class="fn-sep"><div id="isIdle" class="function"><div><h3>isIdle()<span class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l2000">code »</a></span></h3><div><div class="fn-details"><div><b>Returns</b></div><dl><dt><code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean">boolean</a></code><dd><p>Whether this flow is currently idle.</p>
...
</dl></div></div></div></div><hr class="fn-sep"><div id="reset" class="function"><div><h3>reset()<span class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l2007">code »</a></span></h3><p>Resets this instance, clearing its queue and removing all event listeners.</p>
</div></div><hr class="fn-sep"><div id="setPropagateUnhandledRejections" class="function"><div><h3>setPropagateUnhandledRejections(<wbr>propagate)<span class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l1993">code »</a></span></h3><p>Sets whether any unhandled rejections should propagate up through the
...
<a href="enum_webdriver_promise_ControlFlow_EventType.html#UNCAUGHT_EXCEPTION"><code>webdriver.promise.ControlFlow.EventType.UNCAUGHT_EXCEPTION</code></a>
event.</p>
<p>The default behavior is to propagate all unhandled rejections. <em>The use
of this option is highly discouraged.</em></p>
<div><div class="fn-details"><div><b>Parameters</b></div><dl><dt>propagate<code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean">boolean</a></code><dd><p>whether to propagate errors.</p>
</dl></div></div></div></div><hr class="fn-sep"><div id="timeout" class="function"><div><h3>timeout(<wbr>ms, opt_description)<span class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l2140">code »</a></span></h3><p>Inserts a <code>setTimeout</code> into the command queue. This is equivalent to
...
</dl></div></div></div></div><hr class="fn-sep"><div id="toString" class="function"><div><h3>toString()<span class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l1976">code »</a></span></h3><p>Returns a string representation of this control flow, which is its current
...
</dl></div></div></div></div><hr class="fn-sep"><div id="wait" class="function"><div><h3><code>&lt;T&gt;</code> wait(<wbr>condition, opt_timeout, opt_message)<span class="codelink"><a href="source/lib/webdriver/promise.js.src.html#l2183">code »</a></span></h3><p>Schedules a task that shall wait for a condition to hold. Each condition
