...
instance.</p>
</dl></div></div></div></div><hr class="fn-sep"><div id="quit" class="function"><div><h3>quit()<span class="codelink"><a href="source/firefox/index.js.src.html#l295">code »</a></span></h3><p>Schedules a command to quit the current session. After calling quit, this
...
</dl></div></div></div></div><hr class="fn-sep"><div id="setFileDetector" class="function"><div><h3>setFileDetector(<wbr>detector)<span class="codelink"><a href="source/firefox/index.js.src.html#l290">code »</a></span></h3><p>This function is a no-op as file detectors are not supported by this
implementation.</p>
